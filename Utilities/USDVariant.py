...
##########################################
    ...
    compMaterial.parm("matspecpath1").set("/ASSET/mtl/"+ assetMaterial.name())
    ...
    compOutput.parm("variantdefaultgeo").set(assName + "_" + importedAssets[0].name())
    ...
    #assMaterial.moveToGoodPosition()
